...
sns1 = np.loadtxt('output/Apr1_deproj0_tau_0.01_sn.csv')
sns2 = np.loadtxt('output/Apr1_polOnly_deproj0_tau_0.01_sn.csv')
sns3 = np.loadtxt('output/Apr1_deproj1_tau_0.01_sn.csv')
for i in range(len(noises)):
    c = color.next()
    l = ls.next()
    if i == 0:
...
#plt.ylim([15,45])
plt.legend()
plt.savefig('output/Apr1_deproj0_deproj1_sn.png')    
