...
for noiseNow,fskyNow in zip(noiseList,fskyList):
    ...
    ls,Nls,ellbb,dclbb,efficiency,cc = lensNoise(Config,expName,lensName,beamOverride=None,lkneeTOverride=None,lkneePOverride=None,alphaTOverride=None,alphaPOverride=None)
    ...
    np.savetxt('tests/savedFisher_S4_mnu_nnu_omk.csv',Fisher)
    Fisher += otherFisher
